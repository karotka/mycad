...
export function toolIcon(command: ToolbarIcon): string {
  const paths: Partial<Record<ToolbarIcon, string>> = {
    ...
    MLCUT: '<path d="M3 9l7 4-7 4M21 9l-7 4 7 4" stroke-dasharray="0"/><path d="M10 13h4" stroke-dasharray="2 2"/>',
    MLWELD: '<path d="M3 8l7 3v2l-7 3M21 8l-7 3v2l7 3"/><circle cx="12" cy="12" r="1.6"/>',
    MLCORNER: '<path d="M4 4v12h12" stroke-dasharray="0"/><path d="M4 8v8h8" opacity=".55"/><circle cx="4" cy="16" r="1.5"/>',
